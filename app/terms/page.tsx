...
export const metadata: Metadata = { title: "Terms of use | HelpMeHack", description: "These terms describe how HelpMeHack works today. You can browse the Feed and repository directory without an account.", alternates: { canonical: "https://main.d27aveplt50hl3.amplifyapp.com/terms" } };
