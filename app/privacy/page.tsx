...
const sections = [
  ...
  { title: "Analytics", content: <p>We send page views, repository opens, and issue clicks to PostHog&apos;s US service, managed through Tin. Events include session identifiers, browser details, page paths, referring websites, repository names, issue numbers, and a test-traffic label. PostHog also receives network information such as IP addresses. Session storage holds analytics identifiers and referral details. Session recording and automatic click capture are disabled; Do Not Track is respected. URL query strings, fragments, and search terms are removed before sending.</p> },
