  ...
  return (
    <main className="mx-auto max-w-[1080px] px-5 pb-4 sm:px-8">
      <section aria-labelledby="landing-title" className="pb-8 pt-16 sm:pb-14 sm:pt-24">
        ...
        <p className="x-muted mt-6 max-w-[560px] text-pretty text-lg leading-7">Find a project you want to contribute to. Read the Overlooked feed for context, or explore repositories and their open issues.</p>
