      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        {state === "success" ? (
          ...
          <form onSubmit={subscribe} className="mx-auto mt-5 flex max-w-lg flex-col gap-2 sm:flex-row">
            ...
            <input id="newsletter-email" name="email" type="email" autoComplete="email" required maxLength={254} placeholder="you@example.com" className="focus-ring placeholder-muted x-border x-text h-11 min-w-0 flex-1 rounded-full border bg-transparent px-4 text-sm" />
